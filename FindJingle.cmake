...
FIND_LIBRARY(CRYPTO_LIBRARY NAMES libcrypto.so PATH /usr/lib /usr/local/lib)
IF (CRYPTO_LIBRARY)
...
ELSE (CRYPTO_FOUND)
  MESSAGE(FATAL_ERROR "Could not find Crypto, need by jingle")
ENDIF (CRYPTO_FOUND)


FIND_LIBRARY(SSL_LIBRARY NAMES libssl.a PATH /usr/lib /usr/local/lib)
IF (SSL_LIBRARY)
   SET(SSL_FOUND TRUE)
ENDIF (SSL_LIBRARY)
...
set(JINGLE_LIBRARIES ${JINGLE_LIBRARY} ${EXPAT_LIBRARY} ${SRTP_LIBRARY} ${XMPP_LIBRARY} ${CRYPTO_LIBRARY} ${SSL_LIBRARY})